...
export class RemappingComponent implements AfterViewInit, OnInit {
  @ViewChildren('newAssignmentDropsite') newAssignmentDropsite: QueryList<CdkDropList<MapItem>>;
  @ViewChild('availableDropsite', { static: true }) availableDropsite: CdkDropList<MapItem>;
  ...
  available: MapItem[] = [];
  connections: CdkDropList<MapItem>[][] = [];
